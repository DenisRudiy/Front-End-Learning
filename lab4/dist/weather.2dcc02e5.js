...
form.addEventListener("submit", e => {
  ...
  const url = "https://api.openweathermap.org/data/2.5/weather?q=".concat(inputVal, "&appid=").concat(apiKey, "&units=metric");
  fetch(url).then(response => response.json()).then(data => {
    ...
    const icon = "https://s3-us-west-2.amazonaws.com/s.cdpn.io/162656/".concat(weather[0]["icon"], ".svg");
...
},{}],"C:/Users/Denis/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/Denis/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/weather.js"], null)
